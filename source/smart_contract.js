...
exports.postContractEthereumSolidity = function(opt) {
  'use strict';

  return function(sourceCode, parameters, name, callbackUrl, callback) {
...
exports.getContract = function(opt) {
  'use strict';
...
exports.postContractEthereumSolidityFunction = function(opt) {
  'use strict';

  return function(parameters, id, functionName, callback) {
